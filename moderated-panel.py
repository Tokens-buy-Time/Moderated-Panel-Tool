...
prompt += "\n\n You are to put 20 questions to the panel where for each question you choose a particular panel member to kick off the conversation as you determine most appropriate."
